...
# 먼저 두 직사각형의 겹치는 부분이 직사각형인 경우이다. 
# 아래 그림(a)는 공통부분이 직사각형인 경우의 3가지 예를 보여준다,
...
# 여러분은 두 직사각형의 겹치는 부분이 직사각형인지, 선분인지, 점인지, 
# 아니면 전혀 없는 지를 판별해서 해당되는 코드 문자를 출력해야 한다. 
...
# 출력
# 4개의 각 줄에 주어진 두 직사각형의 공통부분을 조사해서 
