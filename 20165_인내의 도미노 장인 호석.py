...
#     a_x = int(a_x)-1
#     a_y = int(a_y)-1
#     dir_x, dir_y = check(a_D)
#     # print(dir_x, dir_y)
#     d_x, d_y = map(int, input().split())
#     d_x -= 1
#     d_y -= 1
#
#     # state[a_x][a_y] = str(state[a_x][a_y])
#     cnt += 1
#
#     for p in range(int(state[a_x][a_y])):
#         n_x = a_x+(dir_x*p)
#         n_y = a_y+(dir_y*p)
#         # num = state[n_x][n_y]
#         state[n_x][n_y] = str(state[n_x][n_y])
#         visited[n_x][n_y] = True
#         # cnt += 1
#         if int(state[n_x][n_y])-1 > 0:
#             while 0<= n_x < N and 0<= n_y < M and int(state[n_x][n_y])-1>0:
#                 n_x += dir_x
#                 n_y += dir_y
#                 if 0 <= n_x < N and 0 <= n_y < M and visited[n_x][n_y] == False:
#                     # num = int(state[n_x+dir_x][n_y+dir_y])
#                     state[n_x][n_y] = str(state[n_x][n_y])
#                     visited[n_x][n_y] = True
#                     cnt += 1
#
#     state[d_x][d_y] = int(state[d_x][d_y])
#     visited[d_x][d_y] = False
#
#
# for a in range(N):
#     for b in range(M):
#         if type(state[a][b]) == str:
#             state[a][b] = 'F'
#         else:
#             state[a][b] = 'S'
#
